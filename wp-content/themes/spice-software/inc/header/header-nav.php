			   ...
			   if ( class_exists( 'WooCommerce' ) ) {
					   ...
					   $spice_software_shop_button .='<div class="cart-header ">';
					      ...
					      if ($woocommerce->cart->cart_contents_count == 0){
					        ...
					        $spice_software_shop_button .= '<a href="'.esc_url($spice_software_link).'" ><span class="cart-total">'.sprintf(_n('%d item', '%d items', $woocommerce->cart->cart_contents_count, 'spice-software' ), $woocommerce->cart->cart_contents_count).'</span></a>';
