<?php
	...
	if (get_theme_mod('it_company_preloader_responsive',true) == true && get_theme_mod('it_company_preloader',false) == false) {
		$it_company_custom_css .='@media screen and (min-width: 575px){
			.preloader, #overlayer, .tg-loader{';
			$it_company_custom_css .=' visibility: hidden;';
		$it_company_custom_css .='} }';
	}
	if (get_theme_mod('it_company_preloader_responsive',true) == false) {
		$it_company_custom_css .='@media screen and (max-width: 575px){
			.preloader, #overlayer, .tg-loader{';
			$it_company_custom_css .=' visibility: hidden;';
		$it_company_custom_css .='} }';
	...
	if (get_theme_mod('it_company_slider_button_responsive',true) == true && get_theme_mod('it_company_slider_button',false) == false) {
		$it_company_custom_css .='@media screen and (min-width: 575px){
			.more-btn{';
			$it_company_custom_css .=' display: none;';
		$it_company_custom_css .='} ';
	...
	if (get_theme_mod('it_company_backtotop_responsive',true) == true && get_theme_mod('it_company_hide_scroll') == false) {
		$it_company_custom_css .='@media screen and (min-width: 575px){
			.show-back-to-top{';
			$it_company_custom_css .=' display: none;';
		$it_company_custom_css .='} ';
	...
	$it_company_menu_font_weight = get_theme_mod('it_company_menu_font_weight');
