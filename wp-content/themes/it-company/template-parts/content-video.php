  ...
  <?php if( get_theme_mod( 'it_company_metafields_date',true) != '' || get_theme_mod( 'it_company_metafields_author',true) != '' || get_theme_mod( 'it_company_metafields_comment',true) != '' || get_theme_mod( 'it_company_metafields_time',true) != '') { ?>
    <div class="post-info py-1 px-2">
      <?php if( get_theme_mod( 'it_company_metafields_date',true) != '') { ?>
        <a href="<?php echo esc_url( get_day_link( $archive_year, $archive_month, $archive_day)); ?>"><span class="entry-date me-2"><i class="fa fa-calendar me-1" aria-hidden="true"></i><?php echo esc_html( get_the_date() ); ?></span> <?php echo esc_html( get_theme_mod('it_company_metabox_seperator','') ); ?> <span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a>
      <?php }?>
      <?php if( get_theme_mod( 'it_company_metafields_author',true) != '') { ?>
        <a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>"><span class="entry-author me-2"><i class="fa fa-user me-1" aria-hidden="true"></i> <?php the_author(); ?></span> <?php echo esc_html( get_theme_mod('it_company_metabox_seperator','') ); ?> <span class="screen-reader-text"><?php the_author(); ?></span></a>
      <?php }?>
      <?php if( get_theme_mod( 'it_company_metafields_comment',true) != '') { ?>
        <span class="entry-comments me-2"><i class="fa fa-comments me-1" aria-hidden="true"></i> <?php comments_number( __('0 Comments','it-company'), __('0 Comments','it-company'), __('% Comments','it-company') ); ?><?php echo esc_html( get_theme_mod('it_company_metabox_seperator','') ); ?></span> 
      <?php }?>
